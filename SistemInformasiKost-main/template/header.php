...
<body>
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <a class="navbar-brand" href="index.php">eRoss</a>
        ...
        <div class="jumbotron bg-info" style="color:white;padding-top:10%;border-radius:20px;">
            ...
            <div class="animated fadeInDown">
                <div class="container-fluid">
                    <div class="col-md-8 col-md-offset-1">
                        ...
                        <h1>Sistem Informasi Kost<br class="visible-lg " />eRoss</h1>
